...
GPTcodex_U is local-first. The update checker may request public GitHub Release metadata from `https://api.github.com/repos/suren-00/GPTcodex_U/releases` during automatic checks when enabled or when the user manually checks for updates.
